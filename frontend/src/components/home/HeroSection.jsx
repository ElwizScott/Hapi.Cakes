...
import { HeartIcon, SparkleIcon, StarIcon } from "../common/BakeryIcons";
  ...
  return (
    <section className="mx-auto max-w-7xl px-3 pt-6 sm:px-6 sm:pt-10 lg:px-8 lg:pt-14">
      <div className="relative isolate overflow-hidden rounded-[2.25rem] border border-white/70 bg-[linear-gradient(135deg,rgba(255,250,245,0.995)_0%,rgba(255,248,252,0.99)_38%,rgba(248,239,250,0.985)_100%)] shadow-[0_30px_80px_rgba(125,106,121,0.14)]">
        <div className="relative p-4 sm:p-8 lg:p-12 lg:pb-16">
          ...
          <div className="relative z-10 grid items-center gap-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.95fr)] lg:gap-12">
            ...
            <div className="relative z-20 mx-auto w-full max-w-[32rem] lg:max-w-none">
              ...
              <div className="relative isolate z-20 rotate-[1.2deg] transition-transform duration-500 ease-soft hover:rotate-0">
                ...
                <div className="absolute -right-4 -top-4 z-30 flex h-16 w-16 -rotate-12 items-center justify-center rounded-full border-2 border-white bg-candy text-center shadow-candyGlow">
                  <span className="font-script text-sm leading-none text-white">
                    fresh
                    <br />
                    today
                  </span>
        ...
        <ScallopDivider fillClassName="text-softBg" size="lg" />
      </div>
    </section>
  );
}
